...
config :mvp_match_code_challenge, MvpMatchCodeChallenge.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "mvp_match_code_challenge_dev",
  stacktrace: true,
...
config :mvp_match_code_challenge, MvpMatchCodeChallengeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/mvp_match_code_challenge_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :mvp_match_code_challenge, dev_routes: true
